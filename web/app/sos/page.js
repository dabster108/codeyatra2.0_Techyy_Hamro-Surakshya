      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-slide-up-fade">
          ...
          <p className="text-base text-slate-500 max-w-xl mx-auto">
            Verified emergency contact numbers for Nepal. Tap any card to call directly from your device.
          </p>
        </div>
          ...
          {EMERGENCY_NUMBERS.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`flex h-14 w-14 flex-none items-center justify-center rounded-xl border ${item.border} ${item.bg} group-hover:shadow-sm transition-all duration-500`}>
                ...
                <div className="flex flex-col items-end pl-4">
                  <span className={`text-xl font-black font-mono tracking-tight transition-colors duration-500 ${item.color}`}>
                    {item.number}
                  </span>
                  <div className="mt-1 flex items-center gap-1 opacity-0 -translate-x-2 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-0">
                    <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400">TAP TO CALL</span>
